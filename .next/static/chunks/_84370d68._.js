...
const Dashboard = (param)=>{
    ...
    const fetchBookmarks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[fetchBookmarks]": async ()=>{
            try {
                setLoading(true);
                const { data, error } = await supabase.from('bookmarks').select('*').order('created_at', {
                    ascending: false
                });
                if (error) throw error;
    ...
    }["Dashboard.useCallback[fetchBookmarks]"], [
        supabase
    ]);
            ...
            const channel = supabase.channel('realtime-bookmarks').on('postgres_changes', {
                ...
                "Dashboard.useEffect.channel": (payload)=>{
                    if (payload.eventType === 'INSERT') {
                        setBookmarks({
                            "Dashboard.useEffect.channel": (prev)=>[
                                    payload.new,
                                    ...prev
                                ]
                        ...
                        setBookmarks({
                            "Dashboard.useEffect.channel": (prev)=>prev.filter({
                                    "Dashboard.useEffect.channel": (b)=>b.id !== payload.old.id
                                }["Dashboard.useEffect.channel"])
                        }["Dashboard.useEffect.channel"]);
                    } else if (payload.eventType === 'UPDATE') {
                        setBookmarks({
                            "Dashboard.useEffect.channel": (prev)=>prev.map({
                                    "Dashboard.useEffect.channel": (b)=>b.id === payload.new.id ? payload.new : b
                                }["Dashboard.useEffect.channel"])
                        }["Dashboard.useEffect.channel"]);
                    }
                }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        lineNumber: 191,
                        columnNumber: 11
                    }, ("TURBOPACK compile-time value", void 0)) : bookmarks.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: bookmarks.map((bookmark)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-blue-50 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "mt-1 line-clamp-1 text-sm text-gray-500 break-all",
...
_s(Dashboard, "g1oNQ3HbE57bSbKlYvyVfHr6RE4=");
_c = Dashboard;
